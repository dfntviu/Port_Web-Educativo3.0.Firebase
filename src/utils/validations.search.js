    ...
    export const searchValidations = {
 	 ...
 	 * */
        ...
        buscarPorCoincidenciaNombre(nombre,alumno){
    	 ...
    	 /**
    	  ...
    	  validarUUID(alumno){
    	 	if(!alumno || !alumno.uuid)
    	 		 console.error('No fue encontrado el alumno o no tienees el uuid váñido');
    	 		 return false;
    	 }
   			/**
    	  ...
    	  validarNomVacio(coincidencias){
    	 	 if (coincidencias.length > 1) {
    	 	 	 console.log(¿'Hay mas de un alumno con el criterio de buasqueda, se usará el 1°');
    	 ...
    	 /**
            *  Control de errores para los servicios asincrónicos
 	 		* @returns {Function} fn
 	 		* @param  {...any} args
